    ...
    try {
      ...
      if (responseData && responseData.token && responseData.user) {
        ...
        if (user.role !== 'FREELANCER') {
          Alert.alert(
            'Access Denied',
            'This app is for Workers only. Please use the Client App.'
          );
          setLoading(false);
          return;
        }
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.headerContainer}>
            <View style={styles.logoIconContainer}>
              <Feather name="repeat" size={40} color="#10b981" style={styles.logoIcon} />
            </View>
          ...
          {forgotMode ? (
            ...
            <View style={styles.card}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  style={[styles.input, otpSent && { backgroundColor: '#f3f4f6', color: '#9ca3af' }]}
...
const styles = StyleSheet.create({
  ...
  logoIcon: {
    transform: [{ scaleX: -1 }], // flips arrows to resemble sync_alt
  },
  logoText: {
    fontSize: 32,
    fontWeight: '800',
  ...
  bottomBlur: {
    ...
    height: 250,
    borderRadius: 125,
    backgroundColor: 'rgba(236, 253, 245, 0.2)',
    zIndex: -1,
  },
  backToSignInBtn: {
    marginTop: 16,
