          ...
          <View style={styles.audioRowWrapper}>
            <View style={styles.audioBubble}>
              ...
              <TouchableOpacity style={styles.playCircle}>
                <Feather name="play" size={14} color="#10b981" style={{ marginLeft: 2 }} />
              </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: '#10b981', // Worker Green base color gradient header
  },
  backButton: {
    padding: 6,
  },
  ...
  myBubble: {
    backgroundColor: '#10b981', // Align with green worker gradient bubble
  ...
  audioBubble: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: '#10b981', // Gradient base green matching Voice Card
