...
final nearbyFreelancersProvider = FutureProvider<List<TalentModel>>((ref) async {
  final repo = ref.watch(discoverRepositoryProvider);
  final result = await repo.searchTalent(lat: 28.6139, lng: 77.209, radius: 25);
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  const Icon(Icons.arrow_drop_down_rounded, size: 16, color: AppColors.onSurfaceVariant),
                                ],
                              ),
                            ),
                          ],
