...
export default function RegisterScreen({ navigation }: RegisterScreenProps) {
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await api.post('/auth/register', {
        ...
        password,
        gender,
        role: 'CLIENT', // Always CLIENT for the client app
      });
  ...
  const handleRoleSelect = (selectedRole: string) => {
    if (selectedRole === 'worker') {
      Alert.alert(
        'Switch App',
        'To register as a Professional Freelancer, please download and use the WorkQuora Worker App.'
      );
    } else {
      setRole('CLIENT');
    }
              ...
              <View style={styles.roleCol}>
                ...
                >
                  <View style={[
                    ...
                    <Feather name="briefcase" size={20} color={role === 'CLIENT' ? '#ffffff' : '#64748b'} />
                  </View>
                ...
                >
                  <View style={[
                    ...
                    <Feather name="tool" size={20} color={role === 'FREELANCER' ? '#ffffff' : '#64748b'} />
                  </View>
                  <View style={styles.roleTextCol}>
