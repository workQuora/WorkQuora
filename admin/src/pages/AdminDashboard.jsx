      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-2xl border p-5 flex flex-col justify-between"
          ...
          <div className="grid grid-cols-2 gap-3 my-4">
            <Link to="/kyc" className="flex flex-col items-center justify-center p-4 rounded-xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.04] hover:border-emerald-500/25 transition-all text-center group cursor-pointer">
            ...
            <Link to="/disputes" className="flex flex-col items-center justify-center p-4 rounded-xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.04] hover:border-rose-500/25 transition-all text-center group cursor-pointer">
            ...
            <Link to="/payments" className="flex flex-col items-center justify-center p-4 rounded-xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.04] hover:border-violet-500/25 transition-all text-center group cursor-pointer">
            ...
            <Link to="/settings" className="flex flex-col items-center justify-center p-4 rounded-xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.04] hover:border-amber-500/25 transition-all text-center group cursor-pointer">
