...
const navItems = [
  ...
  { label: 'Freelancers', icon: Briefcase, path: '/freelancers' },
  { label: 'KYC Queue', icon: ShieldCheck, path: '/kyc' },
  { label: 'Disputes', icon: Scale, path: '/disputes' },
  { label: 'Tasks / Jobs', icon: Briefcase, path: '/tasks' },
  { label: 'Advertisements', icon: MonitorPlay, path: '/ads' },
