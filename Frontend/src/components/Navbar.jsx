...
import {
  ...
  ChevronDown, Crosshair, Search, Loader2, PlusCircle, Wallet, Home, LayoutDashboard, User,
  Menu, X
} from 'lucide-react';
              ...
              <div className="space-y-2.5 text-sm font-bold text-slate-600 dark:text-muted-foreground animate-in fade-in duration-300">
                ...
                {user?.role?.toLowerCase() === 'client' && (
                  <>
                    ...
                    <Link to="/client/dashboard" onClick={() => setMobileOpen(false)} className="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-900 dark:hover:text-foreground transition-colors">
